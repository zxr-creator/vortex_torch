...
// constexpr size_t kApproxRemapSmemMax = 64 * 1024;   // H100 / H200 (Hopper SM_90) — uncomment on H200 if 80 KB triggers `cudaFuncSetAttribute: invalid argument`. 64 KB matches launch usage and always validates.
