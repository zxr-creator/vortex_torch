...
constexpr size_t kSmemMax = 88  * 1024;   // RTX PRO 6000 (Blackwell SM_120, ~99 KB opt-in − ~11 KB static)
// constexpr size_t kSmemMax = 224 * 1024;   // H100 / H200 (Hopper SM_90, 228 KB opt-in)
