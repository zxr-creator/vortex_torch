 ...
 */
 ...
 // workspace, no done_counter, no remap. NUM_THREADS=1024 mirrors
 // kSelCfg1 from the upstream — bench sweep confirmed smaller NT
 // collapses the speedup. Routing decision lives in topk_output_v2.
 // =====================================================================
